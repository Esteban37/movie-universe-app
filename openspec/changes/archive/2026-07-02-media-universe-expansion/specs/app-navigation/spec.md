...
Delta requirements for app navigation: bottom shell, TV detail route, and unified search integration.
...
- **THEN** the route SHALL extract the TV show ID and display `TvShowDetailScreen`
