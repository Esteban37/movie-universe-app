...
DTOs with JSON serialization, remote data source, and repository implementation for TMDB API movie endpoints. Handles the boundary between the TMDB API and the domain layer.
